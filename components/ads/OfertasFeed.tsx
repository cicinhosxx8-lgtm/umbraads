 ...
 *
 * Modo `locked` (plano Free): mostra só os anúncios reais recebidos + N cards
 * bloqueados (skeleton borrado) e esconde o "Carregar mais".
 */
      ...
      {locked ? (
        <div className="mt-8 rounded-2xl border border-line bg-surface px-6 py-8 text-center">
          <div className="text-[17px] font-bold text-zinc-100">
            Você está vendo {ads.length} ofertas no plano Free 🔒
          </div>
